...
Remove-Module MigrateCitrixUPMtoFSLogix -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\MigrateCitrixUPMtoFSLogix.psd1"
Import-Module "$PSScriptRoot\..\MigrateCitrixUPMtoFSLogix.psm1" -Force
