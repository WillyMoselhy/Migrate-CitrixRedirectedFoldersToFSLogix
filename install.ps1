<#
	.SYNOPSIS
		Installs the MigrateCitrixUPMtoFSLogix Module from github
		
	.DESCRIPTION
		This script installs the MigrateCitrixUPMtoFSLogix Module from github.
...
$ModuleName = "MigrateCitrixUPMtoFSLogix"

# Base path to the github repository
$BaseUrl = "https://github.com/<InsertUsernameHere>/MigrateCitrixUPMtoFSLogix"

# If the module is in a subfolder of the cloned repository, specify relative path here. Empty string to skip.
$SubFolder = "MigrateCitrixUPMtoFSLogix"
